...
import 'package:service_admin/app/cards/card_screen.dart';
import 'package:service_admin/app/favs/favs_screen.dart';
import 'package:service_admin/app/products/products_screen.dart';
import 'package:service_admin/app/profile/profile_screen.dart';
import 'package:service_admin/app/shop/shop_screen.dart';
import 'package:service_admin/core/presentation/indicators/toast.dart';
import 'package:service_admin/core/presentation/navs/nav_bar.dart';
import 'package:service_admin/core/presentation/navs/tab_holder.dart';

class ServiceAdminAppScreen extends StatelessWidget {
  const ServiceAdminAppScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const ServiceAdminAppScreenContent();
  }
}

class ServiceAdminAppScreenContent extends StatefulWidget {
  const ServiceAdminAppScreenContent({super.key});

  @override
  State<ServiceAdminAppScreenContent> createState() =>
      _ServiceAdminAppScreenContentState();
}

class _ServiceAdminAppScreenContentState
    extends State<ServiceAdminAppScreenContent> {
